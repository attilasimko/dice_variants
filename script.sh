...
export var10=${10}
export var11=${11}
python3 training.py --base alvis --dataset $var11 --num_epochs 120 --loss $var1 --learning_rate $var2 --alpha1 $var3 --alpha2 $var4 --alpha3 $var5 --alpha4 $var6 --beta1 $var7 --beta2 $var8 --beta3 $var9 --beta4 $var10
wait