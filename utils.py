...
def plot_grad(x, y, model, idx):
    ...
    plt.subplot(453)
    plt.imshow(mime_grads[0, :, :, 0], cmap="gray", interpolation="none")
    plt.colorbar()
    plt.subplot(454)
    plt.imshow(dice_grads[0, :, :, 0], cmap="gray", interpolation="none")
    plt.colorbar()
    plt.subplot(455)
    plt.imshow(mime_grads[0, :, :, 0] - dice_grads[0, :, :, 0], cmap="coolwarm", interpolation="none")
    plt.colorbar()
    ...
    plt.subplot(458)
    plt.imshow(mime_grads[0, :, :, 1], cmap="gray", interpolation="none")
    plt.colorbar()
    plt.subplot(459)
    plt.imshow(dice_grads[0, :, :, 1], cmap="gray", interpolation="none")
    plt.colorbar()
    plt.subplot(4, 5, 10)
    plt.imshow(mime_grads[0, :, :, 1] - dice_grads[0, :, :, 1], cmap="coolwarm", interpolation="none")
    plt.colorbar()
    ...
    plt.subplot(4, 5, 13)
    plt.imshow(mime_grads[0, :, :, 2], cmap="gray", interpolation="none")
    plt.colorbar()
    plt.subplot(4, 5, 14)
    plt.imshow(dice_grads[0, :, :, 2], cmap="gray", interpolation="none")
    plt.colorbar()
    plt.subplot(4, 5, 15)
    plt.imshow(mime_grads[0, :, :, 2] - dice_grads[0, :, :, 2], cmap="coolwarm", interpolation="none")
    plt.colorbar()
    ...
    if (np.shape(y)[3] == 4):
        ...
        plt.subplot(4, 5, 18)
        plt.imshow(mime_grads[0, :, :, 3], cmap="gray", interpolation="none")
        plt.colorbar()
        plt.subplot(4, 5, 19)
        plt.imshow(dice_grads[0, :, :, 3], cmap="gray", interpolation="none")
        plt.colorbar()
        plt.subplot(4, 5, 20)
